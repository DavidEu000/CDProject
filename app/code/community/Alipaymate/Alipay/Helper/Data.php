...
class Alipaymate_Alipay_Helper_Data extends Mage_Payment_Helper_Data
{
    private $_logDir  = 'alipay';
    ...
    {
        $this->_debug = Mage::getStoreConfig('payment/alipay/debug');
    }
    ...
    /**
     * Create log directory for 'alipay' payment method
     * Location is /public_html/var/log/alipay
     */
