...
class Alipaymate_Unionpay_Helper_Data extends Mage_Payment_Helper_Data
{
    private $_logDir  = 'unionpay';
    ...
    {
        $this->_debug = Mage::getStoreConfig('payment/unionpay/debug');
    }
    ...
    /**
     * Create log directory for 'unionpay' payment method
     * Location is /public_html/var/log/unionpay
     */
