...
function  updateDeleteLinks(){	
	if(_skipProductlink){
		assignAjaxUpdatetoLink('checkout/cart/delete',true,Translator.translate('Are you sure you would like to remove this item from the shopping cart?'),_skipProductlink);
	}
	assignAjaxUpdatetoLink('checkout/cart/delete',true,Translator.translate('Are you sure you would like to remove this item from the shopping cart?'),_skipProductlink);
}

function  updateRemovePCompareLinks(){	
	assignAjaxUpdatetoLink('catalog/product_compare/remove',true,Translator.translate('Are you sure you would like to remove this item from the comparison list?'));
}
function  updateClearPCompareLinks(){	
	assignAjaxUpdatetoLink('catalog/product_compare/clear',true,Translator.translate('Are you sure you would like to remove all products from your comparison?'));	
}
...
function  updateRemoveWishLinks(){	
	assignAjaxUpdatetoLink('wishlist/index/remove',true,Translator.translate('Are you sure you would like to remove this item from the your wishlist?'));	
}
