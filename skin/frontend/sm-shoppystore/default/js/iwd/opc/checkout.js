...
IWD.OPC = {
		...
		initSaveOrder: function(){
			...
			$j(document).on('click', '.opc-btn-checkout', function(){
				...
				// Added by Vanmazing on April 24,2018
				var idcardForm = new VarienForm('idcard-form', { onSubmit : false, stopOnFirst : false, focusOnError : false});
				var addressForm = new VarienForm('opc-address-form-billing');
				if (!addressForm.validator.validate() || !idcardForm.validator.validate()){
					return;
				}
